 ...
 *
 * 사용법:
 *   npx tsx scripts/run-sql.ts "SELECT * FROM profiles LIMIT 5"
 *   npx tsx scripts/run-sql.ts --file scripts/sql/my-query.sql
 *
...
사용법:
  npx tsx scripts/run-sql.ts "SELECT * FROM table_name"
  npx tsx scripts/run-sql.ts --file scripts/sql/query.sql
