...
async function analyze() {
  ...
  console.log(
    `   3개: ${groups[3].length}명, 2개: ${groups[2].length}명, 1개: ${groups[1].length}명`
  )
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
...
async function showStatus() {
  ...
  for (const [name, records] of Object.entries(byDonor)) {
    ...
    for (const r of records) {
      ...
      console.log(
        `  ${r.sig_number}번째: EP${r.episode_number} ${r.daily_amount.toLocaleString()}하트 [${status}]`
      )
    }
    console.log('')
  }
